...
class TestValidators(object):
    def test_valid(self):
        valid_vatin = VATIN(VALID_VIES_COUNTRY_CODE, VALID_VIES_NUMBER)
    ...
    def test_invalid(self):
        invalid_number_vatin = VATIN(VALID_VIES_COUNTRY_CODE, '12345678')
        invalid_country_vatin = VATIN('XX', VALID_VIES_NUMBER)
        validator = VATINValidator()
